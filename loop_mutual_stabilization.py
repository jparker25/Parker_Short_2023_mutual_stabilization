# Run loop mutual stabilization scenario.
...
def unidirectional_loop(direc, dt, tf, neurons, control1, ifm, ifn):
    """
    Simulates the loop of number of neurons specified by neurons.
    """
...
def plot_loop_mutual_stabilization(sol, neurons, save_direc):
    """
    Plots the loop mutual stabilization result.
    """
...
def generate_figure_7(
    ...
    """
    Simulates and plots Figure 7, loop mutual stabilization scenario.
    """
    np.random.seed(24)
    ...
    run_cmd(f"cp {save_direc}/neural_states_3d.eps paper_figures/figure_7.eps")
